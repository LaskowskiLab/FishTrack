...
rpicam-vid --width $width --height $height --framerate $fps --quality $quality $preview --timeout $((($hours*60 + $minutes)*60*1000)) --output $directory_path$pi_name.$dt_stamp.$format -v $verbose
