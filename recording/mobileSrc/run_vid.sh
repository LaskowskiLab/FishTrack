...
directory_path=$data_dir$date_stamp.$suffix/ 
...
echo rpicam-vid --width 1080 --height 1080 --framerate $f_rate --quality 17 --nopreview --timeout $((($n_hours*60 + $n_minutes)*60*1000)) --output $directory_path$pi_name.$dt_stamp.h264 -v 0
