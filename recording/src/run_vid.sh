...
raspivid --width 500 --height 500 --framerate 1 --qp 17 --timeout $((14*60*60*1000)) ---output $directory_path$pi_name.$date_stamp 

## Use this line if the video will be too big:
#raspivid --width 500 --height 500 --framerate 1 --qp 17 --timeout $((14*60*60*1000)) --segment $((60*60*1000)) ---output $directory_path$pi_name.$date_stamp-%02d.mp4
